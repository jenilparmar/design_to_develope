...
export default function Galler() {
  return (
    <div className="ml-20 bg-[#29274c]  h-screen relative ">
      <div className="fixed top-0  bg-[#29274c]">
        <div className="">
        ...
        <div className="popular h-[158px]  flex  px-9 gap">
          ...
          <div className=" ml-3 rounded-3xl px-6 py-4 subscription h-[158px] w-[395px] bg-[#393B70]">
