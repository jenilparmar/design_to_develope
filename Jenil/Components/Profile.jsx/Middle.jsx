        ...
        <div className="flex flex-row  justify-between">
         ...
         <div className="flex flex-col">
          <div
            ...
            <p className="self-center ml-20 py-2 text-xl  text-[#87878d]  font-medium">Joginder </p>
          </div>
            ...
            <div className="flex flex-col text-[#87878d] p-5 ">
                ...
                <button className="self-start m-5  px-3 py-1 rounded-xl border-2 border-[#87878d] text-[#87878d] hover:scale-105 transition-all duration-150">Set Up Profile</button>
        </div>
        <div className="ml-20 text-[#87878d]    ">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo sed, eos odit officia temporibus deserunt. Voluptatem, cupiditate doloremque animi commodi quidem quo hic non fugiat voluptates ducimus laboriosam earum esse. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio nesciunt dolorem architecto repellendus explicabo. Iure aliquam eaque doloribus tenetur excepturi repudiandae blanditiis, porro, error ipsum suscipit rerum, temporibus consequuntur cupiditate?</div>
      </div>
    </div>
  );
};
