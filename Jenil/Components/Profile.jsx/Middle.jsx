    ...
    <div className="w-2/3 h-fit bg-[#29274c] flex flex-col">
      ...
      <div className="w-full h-80 bg-[#29274c] -mt-20 flex flex-col">
        ...
        <div className="ml-20 text-[#87878d]    ">
          ...
          sed, eos odit officia temporibus deserunt. Voluptatem, cupiditate
          doloremque animi commodi quidem quo hic non fugiat voluptates ducimus
          laboriosam earum esse. Lorem ipsum, dolor sit amet consectetur
          adipisicing elit. Odio nesciunt dolorem architecto repellendus
          explicabo. Iure aliquam eaque doloribus tenetur excepturi repudiandae
          blanditiis, porro, error ipsum suscipit rerum, temporibus consequuntur
          cupiditate?
        </div>
      </div>
