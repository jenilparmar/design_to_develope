...
const Thoughts = () => {
  return (
    <div className="pons w-full h-screen overflow-y-scroll overflow-x-hidden self-end  ">
      ...
      <ThoughtOfDay
        text={
          "Zindagi ka ek simple formula hai: agar aaj ka din accha guzar gaya, toh kal bhi accha hoga."
        }
      />
      <ThoughtOfDay
        text={
          "Kuch din aise hote hain jab aap bas chill karna chahte ho, bina kisi tension ke."
        }
      />
      <ThoughtOfDay
        text={
          "Aaj ka din ek reminder tha ki khud se pyar karna aur apne liye waqt nikalna zaroori hai."
        }
      />
      <ThoughtOfDay
        text={
          "Doston ke saath kiya gaya ek chota sa conversation bhi puri duniya ki tension bhoolane ke liye kaafi hota hai."
        }
      />
      <ThoughtOfDay
        text={
      ...
      <ThoughtOfDay
        text={
          "Lecture ke dauran soch raha tha ki zindagi ke bade decisions kaise liye jaye."
        }
      />
      <ThoughtOfDay
        text={
          "College ki dincharya waise hi hectic thi, par friends ke saath time bitaana sabse bada stress-buster hai."
        }
      />
      <ThoughtOfDay
        text={
          "Aaj bhi professor ka lecture samajh nahi aaya, par canteen ki chai ne sab kuch bhoolane ka moka diya."
        }
      />
      <ThoughtOfDay
        text={
      ...
      <ThoughtOfDay
        text={
          "Kabhi kabhi, campus ki walk pe jaane se bhi mann halka ho jata hai."
        }
      />
      <ThoughtOfDay
        text={
          "Kuch naye decisions liye hain aaj, dekhte hain yeh zindagi mein kya rang laate hain."
        }
      />
      <ThoughtOfDay
        text={
          "Library mein baithe baithe aaj realize kiya ki kitni kitabein padhi ja sakti hain."
        }
      />
      <ThoughtOfDay
        text={"Assignments complete ho gaye, aur ab relax karne ka time hai!"}
      />
      <ThoughtOfDay
        text={
          "Aaj ka din bohot productive tha, assignments aur doston ke saath waqt bhi spend ho gaya."
        }
      />
      <ThoughtOfDay text={"Akkad bakkad bambe bo assi nabbe nai hote sau!"} />
      <ThoughtOfDay
        text={
          "Lecture mein toh dimag mein chhutti thi, par campus ki walk ne sab kuch clear kar diya."
        }
      />
      <ThoughtOfDay
        text={
      ...
      />
      <ThoughtOfDay
        text={"Har kisi ke saath waqt guzarna ek naya experience deta hai."}
      />
      <ThoughtOfDay
      ...
      <ThoughtOfDay
        text={
          "Kabhi kabhi, ek choti si chai ki chuski bhi din ko bana deti hai."
        }
      />
      <ThoughtOfDay
        text={"Yeh din hamesha yaad rahenge, jab hum sab ek saath the."}
      />
      <ThoughtOfDay
        text={
          "Padhai se break leke doston ke saath maze karna bhi zaroori hai."
        }
      />
      <ThoughtOfDay
        text={
